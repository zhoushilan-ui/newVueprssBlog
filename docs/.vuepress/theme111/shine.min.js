...
!(function (a, b) {
  (b.shinejs = a),
    ...
    (window.performance = window.performance ||
      window.webkitPeformance ||
      window.mozPeformance || {
        now: function () {
  ...
  "undefined" != typeof define &&
    ...
    (c.Config = function (a) {
      (this.numSteps = 5),
        ...
        (this.blur = 40),
        (this.blurPow = 1),
        (this.shadowRGB = new c.Color(0, 0, 0)),
        this.applyValues(a);
    }),
    ...
    (c.Shadow = function (a) {
      (this.position = new c.Point(0, 0)),
        ...
        window.addEventListener("load", this.fnHandleWindowLoaded, !1);
    }),
    (c.Shadow.prototype.destroy = function () {
      window.removeEventListener("load", this.fnHandleWindowLoaded, !1),
    ...
    (c.Shadow.prototype.enableAutoUpdates = function () {
      this.disableAutoUpdates();
      var a = (this.fnHandleViewportUpdate = c.Timing.debounce(
        this.handleViewportUpdate,
        1e3 / 15,
        this
      ));
    ...
    (c.Shadow.prototype.disableAutoUpdates = function () {
      ...
      a &&
        ((this.fnHandleViewportUpdate = null),
        document.removeEventListener("resize", a, !1),
        window.removeEventListener("resize", a, !1),
        window.removeEventListener("scroll", a, !1));
    }),
    (c.Shadow.prototype.handleViewportUpdate = function () {
      var a = this.domElement.getBoundingClientRect();
      (this.position.x = a.left + 0.5 * a.width),
        (this.position.y = a.top + 0.5 * a.height);
    }),
    ...
    (c.Splitter.prototype.split = function (a, b) {
      (this.text = a || this.text),
        ...
        a && (this.domElement.textContent = this.text),
        b
          ? this.splitChildren(
              this.domElement,
              this.maskElement,
      ...
      for (var e = a.textContent, f = e.length, g = null, h = 0; f > h; h++) {
        ...
        if (
          (g ||
            ...
            (g.className = d + "word"),
            c.appendChild(g),
            this.wordElements.push(g)),
          i.match(/[\s]/))
        ) {
          var j = document.createElement("span");
          (j.className = d + "spacer"),
            (j.innerHTML = i),
            c.appendChild(j),
            (g = null);
        } else {
    ...
    (c.StyleInjector.instance_ = null),
    (c.StyleInjector.getInstance = function () {
      return (
        c.StyleInjector.instance_ ||
          (c.StyleInjector.instance_ = new c.StyleInjector()),
        c.StyleInjector.instance_
      );
    }),
    (c.StyleInjector.prototype.inject = function (a, b) {
      if (((b = b || window.document), this.injections[a] !== b)) {
        ...
        return (
          b.getElementsByTagName("head")[0].insertBefore(c, d),
          (this.injections[a] = b),
          c
        );
      }
    ...
    (c.Timing.throttle = function (a, b, c) {
      ...
      return function () {
        ...
        var f = window.performance.now(),
          g = arguments;
        !isNaN(d) && d + b > f
          ? (isNaN(e) || clearTimeout(e),
            (e = setTimeout(function () {
              (d = f), a.apply(c, g);
            }, b)))
          : (isNaN(e) || clearTimeout(e), (d = f), a.apply(c, g));
      };
    }),
    (c.Shine = function (a, b, d, e) {
      if (!a) throw new Error("No valid DOM element passed as first parameter");
      (this.light = new c.Light()),
        (this.config = b || new c.Config()),
        (this.domElement = a),
        (this.classPrefix = d || "shine-"),
        (this.shadowProperty =
          e || (this.elememtHasTextOnly(a) ? "textShadow" : "boxShadow")),
        (this.shadows = []),
        (this.splitter = new c.Splitter(a, this.classPrefix)),
        (this.areAutoUpdatesEnabled = !0),
        (this.fnDrawHandler = null),
        this.updateContent();
    }),
    (c.Shine.prototype.destroy = function () {
      this.disableAutoUpdates();
      for (var a = this.shadows.length - 1; a >= 0; a--)
        this.shadows[a].destroy();
      (this.light = null),
        (this.shadows = null),
        (this.splitter = null),
        (this.fnDrawHandler = null);
    ...
    (c.Shine.prototype.draw = function () {
      for (var a = this.shadows.length - 1; a >= 0; a--)
        this.shadows[a].draw(this.light, this.config);
    }),
    (c.Shine.prototype.updateContent = function (a) {
      ...
      this.disableAutoUpdates(),
        ...
        this.splitter.split(a, !a && !this.elememtHasTextOnly(this.domElement));
      for (
        var d = this.getPrefixed(this.shadowProperty), e = 0;
        e < this.splitter.elements.length;
        e++
      ) {
    ...
    (c.Shine.prototype.getPrefixed = function (a) {
      for (
        var b = this.domElement || document.createElement("div"),
          c = b.style,
          d = ["webkit", "ms", "Moz", "Webkit", "O"],
          e = a.charAt(0).toUpperCase() + a.substring(1),
          f = 0;
        f < d.length;
        f++
      ) {
